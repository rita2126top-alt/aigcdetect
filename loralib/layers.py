...
class LinearLoRA(nn.Linear, LoRALayer):
    ...
    def forward(self, x: torch.Tensor, **kwargs):
        ...
        if self.r > 0:
            ...
            lora_A = getattr(self, 'w_lora_A')
            lora_B = getattr(self, 'w_lora_B')
            ...
            lora_adjustment = (lora_input @ lora_A.transpose(0, 1) @ lora_B.transpose(0, 1)) * self.scaling
